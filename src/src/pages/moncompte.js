...
import { Container, Col, Row, Button, Form, Breadcrumb, Tab, Tabs } from "react-bootstrap";
...
<Container>
      ...
      fill
    >
      <Tab eventKey="Mes informations personnelles" title="Mes informations personnelles">
      <Container>
        ...
        <Row className="main-user-info">
          <Col>
            <Form.Group controlId="nom_prenom_raison">
              ...
              <Form.Control type="text" name="nom_prenom_raison" className="long1" />
            </Form.Group>
          </Col>
        </Row>
      ...
      <Tab eventKey="Paramétrage de la sécurité" title="Paramétrage de la sécurité">
      <Container>
      <Form className="register">
      <Row className="main-user-info">
          <Col md={6}>
            <Form.Group controlId="email" className="gray-background">
              ...
              <Form.Control type="email" name="email" className="grey" required readOnly/>
            </Form.Group>
          </Col>
          </Row>
          <Row className="main-user-info">
          <Col md={6}>
            <Form.Group controlId="password">
              ...
              <Form.Control type="password" name="password" className="mail_input" required />
            </Form.Group>
          </Col>
          </Row>
          <Row className="main-user-info">         
          ...
          <Col md={6}>
            <Form.Group controlId="confirm_password">
              <Form.Label  ClasseName="label">Confirmation du nouveau mot de passe :</Form.Label>
              <Form.Control
                type="password"
