        ...
        <Container className="register">
          ...
          <div className="pb-2">
            ...
            <p>
              ...
              fonctionnalités de notre logiciel via une connexion à notre
              serveur par Internet. Les données du Client sont traitées et
              sauvegardées sur notre serveur. Nous assurons l’hébergement, la
              sécurité, la maintenance du logiciel, ainsi qu’une assistance
              technique par e-mail ou téléphone.
            </p>
            <p>
          ...
          <div className="pb-2">
            ...
            <p>
              ...
              exclusivement par connexion sécurisée avec les identifiants
              fournis. Nous garantissons une disponibilité du service 24h/24 et
              7j/7, sous réserve des interruptions dues à des problèmes
              techniques ou des événements imprévus.
            </p>
          </div>
          <div className="pb-2">
            <h4>Responsabilités du Client</h4>
            <p>
              Le Client est responsable des données qu’il saisit dans le
              logiciel, notamment des montants, des rubriques et des
              exonérations à appliquer. Toute erreur ou omission dans ces
              données relève de sa responsabilité exclusive, car le logiciel est
              mis à disposition pour lui permettre de gérer ses propres
          ...
          <div className="pb-2">
            ...
            <p>
              ...
              pour assurer la continuité du service et la sécurité de vos
              données. Nous sommes responsables de la maintenance et des mises à
              jour du logiciel, ainsi que de la sauvegarde régulière de vos
              informations.
            </p>
            <p>
              Nous nous assurons de la conformité du logiciel aux normes du
              marché et de son évolution continue pour offrir une expérience
              optimale.
            </p>
          </div>
          <div className="pb-2">
            ...
            <p>
              Le site Déclaration Facile est propriétaire des droits de
              propriété intellectuelle relatifs au logiciel Déclaration Facile.
              Le Client bénéficie d'un droit d’utilisation non exclusif et non
              transférable. Il est interdit de reproduire, altérer ou contourner
              les protections mises en place sur notre logiciel.
            </p>
            <p>
          ...
          <div className="pb-2">
            ...
            <p>
              ...
              donnée ne sera communiquée à des tiers sans votre accord
          ...
          <div className="pb-2">
            ...
            <p>
              Notre site contient des informations légales mises à disposition
              des utilisateurs. Nous faisons tout notre possible pour garantir
              leur mise à jour. Cependant, nous encourageons nos utilisateurs à
