    ...
    return (
      <>
        ...
        <Container className="register">
          ...
          <div className="pb-2">
            <p>
              <strong>Déclaration Facile</strong> est une plateforme innovante
              et intuitive, conçue pour simplifier la gestion en ligne des
              déclarations de TVA et des informations fiscales. Premier service
              de ce genre en Tunisie, il répond aux besoins des PME, professions
            ...
            <p>
              ...
              performants permettant de gérer vos obligations fiscales de
              manière efficace, que vous soyez en Tunisie ou à l’étranger.
            </p>
          </div>
          <div className="pb-3">
            <h4>Notre mission</h4>
          ...
          <div className="pb-2">
            ...
            <p>
              ...
              significative en comptabilité et gestion financière. Il a
              accompagné de nombreuses entreprises dans leurs obligations
              fiscales et sociales, garantissant un respect optimal des normes
              réglementaires.
            </p>
          ...
          <div className="pb-3">
            ...
            <p>
              <strong>Avec Déclaration Facile</strong>, facilitez vos démarches
              et concentrez-vous sur le développement de votre activité.
            </p>
          </div>
        </Container>
      </>
